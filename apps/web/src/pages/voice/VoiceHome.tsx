  ...
  return (
    <div className="max-w-5xl space-y-6">
      ...
      {tab === "campaigns" && (
        <div>
          <div className="flex justify-end mb-3">
            <Link to="/voice/campaigns/new" className="bg-red-600 text-white text-sm font-medium rounded-md px-4 py-2 hover:bg-red-700">
              + New Campaign
            </Link>
          </div>
      ...
      {tab === "agents" && (
        <div>
          <div className="flex justify-end mb-3">
            <Link to="/voice/agents/new" className="bg-red-600 text-white text-sm font-medium rounded-md px-4 py-2 hover:bg-red-700">
              + New Agent
            </Link>
          </div>
